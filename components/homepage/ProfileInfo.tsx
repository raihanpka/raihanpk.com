...
import { Briefcase, MapPin, Mail, Linkedin, Github, Instagram } from 'lucide-react';

const ProfileCardInfo = () => {
  return (
    <div className="p-3">
      <h3 className="text-lg font-medium text-gray-800 dark:text-white">Raihan Putra Kirana</h3>
      <h5 className="text-gray-700 dark:text-gray-400">Learner | Tech Enthusiast</h5>
      <div className="mb-2 mt-2 space-y-3">
        ...
        <div className="flex items-center">
          ...
          <p className="px-2">
            Bogor - Indonesia, <Twemoji emoji="indonesia-flag" />
          </p>
        </div>
        <div className="flex items-center">
