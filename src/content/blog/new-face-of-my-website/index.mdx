...
description: 'Inilah alasan mengapa aku merombak total website raihanpk.com ini!'
date: 2025-03-15
...
Tapi, masalahnya… website yang aku punya selama ini tuh adalah website statis! Maksudku, untuk apa menggunakan *heavy framework* seperti **Next.js** kalau cuma dipakai untuk menampilkan artikel dan portofolio? *Overkill*, nggak sih?
...
Intinya waktu itu, saat **Astro** baru banget dapat *major update*, salah satu review dari alumni yang aku ingat banget saat itu katanya "**Astro** adalah framework yang ringan dan ngebut daripada framework **React/JS based** lainnya". 
...
Nah **Astro** ini merupakan framework baru yang tidak ikut arus framework **React/JS based** lainnya yang bisa dibilang cukup berat. 
